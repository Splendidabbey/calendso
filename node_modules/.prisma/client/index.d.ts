...
export namespace Prisma {
  ...
  */
  ...
  export type AggregateEventType = {
    count: EventTypeCountAggregateOutputType | null
    avg: EventTypeAvgAggregateOutputType | null
    sum: EventTypeSumAggregateOutputType | null
    min: EventTypeMinAggregateOutputType | null
    max: EventTypeMaxAggregateOutputType | null
  }
  ...
  export type EventTypeAggregateArgs = {
    ...
    **/
    orderBy?: Enumerable<EventTypeOrderByInput>
    /**
    ...
    **/
    count?: true | EventTypeCountAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to average
    **/
    avg?: EventTypeAvgAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to sum
    **/
    sum?: EventTypeSumAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to find the minimum value
    **/
    min?: EventTypeMinAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to find the maximum value
    **/
    max?: EventTypeMaxAggregateInputType
  }

  export type GetEventTypeAggregateType<T extends EventTypeAggregateArgs> = {
    [P in keyof T & keyof AggregateEventType]: P extends 'count'
      ? T[P] extends true
        ? number
  ...
  export type EventTypeGetPayload<
    ...
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof EventType ?EventType [P]
  : 
          P extends 'user'
  ...
  export type UserGetPayload<
    ...
    ? User  & {
    [P in TrueKeys<S['include']>]: 
          P extends 'eventTypes'
        ? Array < EventTypeGetPayload<S['include'][P]>>  :
        P extends 'credentials'
        ? Array < CredentialGetPayload<S['include'][P]>>  : never
  } 
    : 'select' extends U
    ? {
  ...
  : 
          P extends 'eventTypes'
        ? Array < EventTypeGetPayload<S['select'][P]>>  :
        P extends 'credentials'
        ? Array < CredentialGetPayload<S['select'][P]>>  : never
  } 
    : User
  : User
  ...
  export type UserUpdateOneWithoutEventTypesInput = {
    create?: XOR<UserCreateWithoutEventTypesInput, UserUncheckedCreateWithoutEventTypesInput>
    connectOrCreate?: UserCreateOrConnectWithoutEventTypesInput
  ...
  export type EventTypeUpdateManyWithoutUserInput = {
    create?: XOR<Enumerable<EventTypeCreateWithoutUserInput>, Enumerable<EventTypeUncheckedCreateWithoutUserInput>>
    connectOrCreate?: Enumerable<EventTypeCreateOrConnectWithoutUserInput>
